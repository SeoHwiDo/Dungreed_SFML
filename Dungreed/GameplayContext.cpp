...
GameplayContext::GameplayContext(Player &player, Camera &camera) : m_player(player), m_camera(camera) {}

bool GameplayContext::placePlayerAtRoomSpawn(const Room &room, const TileMap &tileMap, float zoom) {
