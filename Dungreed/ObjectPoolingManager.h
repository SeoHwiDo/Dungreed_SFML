...
class ObjectPoolingManager {
  ...
  private:
    ...
    struct InactiveSlotCompare {
        bool operator()(const InactiveSlot &left, const InactiveSlot &right) const { return left.availableOrder > right.availableOrder; }
    };
    ...
    std::priority_queue<InactiveSlot, std::vector<InactiveSlot>, InactiveSlotCompare> m_inactiveMonsterSlots;
    std::priority_queue<InactiveSlot, std::vector<InactiveSlot>, InactiveSlotCompare> m_inactiveProjectileSlots;
    std::priority_queue<InactiveSlot, std::vector<InactiveSlot>, InactiveSlotCompare> m_inactiveEffectSlots;
