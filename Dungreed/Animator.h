...
enum class AnimState { Idle, Run, Jump, Attack, Dead };
...
struct AnimationClip {
    ...
    AnimationClip(const std::vector<sf::IntRect> *animationFrames, float duration, bool loop) : frames(animationFrames), frameDuration(duration), isLoop(loop) {}
};
